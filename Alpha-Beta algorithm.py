...
def minimax(position, alpha, beta, maximizing_player):
    ...
    if maximizing_player:
        ...
        for possible_move in position.available_moves():
            ...
            sim_score = minimax(position, alpha, beta, False)
        ...
        for possible_move in position.available_moves():
            ...
            sim_score = minimax(position, alpha, beta, True)
            position.board[possible_move] = ' '
            position.current_winner = None
            sim_score['position'] = possible_move
...
def play_game():
    ...
    while t.empty_squares():
        if t.num_empty_squares() % 2 == 0:
            ...
            best_move = minimax(t, -math.inf, math.inf, True)
